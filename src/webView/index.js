...
window.addEventListener("message", event =>{
  ...
  if (message.imageData){
    let imgData = drawImageWithTile(256, 240, GAME_TILE_X, GAME_TILE_Y, message.imageData);
  ...
  if (message.patternImage){
    let paletteImage = drawImageWithTile(16*8, 16*8, PALETTE_TABLE_TILE_X, PALETTE_TABLE_TILE_Y, message.patternImage);
  ...
  if (message.patternImage2){
    let paletteImage = drawImageWithTile(16*8, 16*8, PALETTE_TABLE_TILE_X, PALETTE_TABLE_TILE_Y, message.patternImage2);
